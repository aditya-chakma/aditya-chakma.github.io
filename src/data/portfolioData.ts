...
export interface BdmoImage {
    src: string;
    year: string;
    alt: string;
}

// 1. Technical Skills Data
...
export const onlineCertifications: Certification[] = [
...
export const bdmoImages: BdmoImage[] = [
...
export const perfectAttendanceImage = "/assets/perfect_attendance.jpeg";
